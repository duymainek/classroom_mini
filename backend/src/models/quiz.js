 ...
 */
function validateQuizCreation(data) {
  const { error, value } = createQuizSchema.validate(data, { 
    abortEarly: false,
    stripUnknown: true
  });
 ...
 * @returns {{isValid: boolean, errors?: Object[], data?: Object}}
 */
function validateQuizUpdate(data) {
  const { error, value } = updateQuizSchema.validate(data, { 
    abortEarly: false,
    stripUnknown: true
  });
 ...
 * @returns {{isValid: boolean, errors?: Object[], data?: Object}}
 */
function validateQuestionCreation(data) {
 ...
 * @returns {{isValid: boolean, errors?: Object[], data?: Object}}
 */
function validateQuestionUpdate(data) {
...
function validateQuizSubmission(data) {
  const { error, value } = createQuizSubmissionSchema.validate(data, { 
    abortEarly: false,
    stripUnknown: true
  });
...
/**
 * Validate grade quiz submission
 * @param {Object} data - Request data to validate
 * @returns {{isValid: boolean, errors?: Object[], data?: Object}}
 */
function validateGradeQuizSubmission(data) {
  const { error, value } = gradeQuizSubmissionSchema.validate(data, { 
    abortEarly: false,
    stripUnknown: true
  });
